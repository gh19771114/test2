...
export default function PatioSuginami203Page() {
  const { t } = useLanguage()
  const p = t('maimai.propertyDetail.properties.patio-suginami-203', { returnObjects: true }) as any
    ...
    <PageLayout>
      <main className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <section className="bg-white py-12">
          <div className="container-custom">
            <div className="mx-auto max-w-6xl">
              <h2 className="mb-6 text-xl font-semibold text-slate-900">{labels.photos}</h2>
        ...
        <section className="mx-auto mt-6 max-w-6xl px-4 pb-14">
          <div className="grid gap-10 lg:grid-cols-[2fr,1.2fr]">
            <div>
              ...
              {/* 投资亮点 */}
              <h2 className="mt-8 text-lg font-semibold text-slate-900">{labels.investmentPoints}</h2>
              ...
              {/* 周边设施 */}
              <h2 className="mt-10 text-lg font-semibold text-slate-900">{labels.surroundings}</h2>
